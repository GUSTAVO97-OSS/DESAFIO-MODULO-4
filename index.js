function addTitleWelcome(params = {}) {
    ...
    function getDataBaseWelcome() {
        return fetch('https://cdn.contentful.com/spaces/u29bhevfkwtl/environments/master/entries?access_token=8_TL01eNg6iCgTonIu91bU60TiUrumDrxXgcBPU8ZmY&content_type=welcome').then((res)=> {
            return res.json();
        }).then((data)=> {
    ...
    function getDataBasePresentation() {
        return fetch('https://cdn.contentful.com/spaces/u29bhevfkwtl/environments/master/entries?access_token=8_TL01eNg6iCgTonIu91bU60TiUrumDrxXgcBPU8ZmY&content_type=presentacion').then((res)=> {
            return res.json();
        }).then((data)=> {
